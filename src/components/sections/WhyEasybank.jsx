  ...
  return (
    <section className="WhyEasybank">
      <div className="WhyEasybank__main">
        ...
        <p className="WhyEasybank__main--description">We leverage Open Banking to turn your bank account into your financial hub. Control your finances like never before.</p>
      </div>
